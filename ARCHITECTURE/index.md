...
本目录是 simple-harness-memory-sdk 的当前架构事实源。当前 0.5.0 已实现 Agent Memory v1 direct
...
identity/provenance门禁，以及基于 Harness 0.4 共享协议的 Memory observability S1+S2。0.5.0 release
identity 已冻结但尚未 tag/push/publish；公开 builders、
