...
新三控已写未运行：真实observation链与REVISE、旧ref过期续期/已消费、prepare后forget。Host恢复/并发/drift另验，不重跑SDK原绿，不独立版本/build。Host准确契约：/Users/denny/projects/simple_harness-corpus-clock/plans/2026-09-06-procedure-adoption/RECOVERY.md。
