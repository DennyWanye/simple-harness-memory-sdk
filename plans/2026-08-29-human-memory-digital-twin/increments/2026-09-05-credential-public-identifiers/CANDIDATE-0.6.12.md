...
Date: 2026-09-05. User allocated unused0.6.12 after fixedsource review.
Dirac scoped ACCEPT ce1a85b7dae1b709d1f8fa53889e2c9e75b20e63: finite vocabulary
repair, source/public-factory evidence accepted; no new P0/P1.

Public snapshot adds version0.6.12 only; all0.6.11 exports/migration names retained.
No DDL/hash/receipt/archive change. Old0.6.10/0.6.11 bytes remain frozen.
Production source remains the independently accepted scanner plus version literal.

Authorized gate: two offline builds from this clean commit, exact installed
Memory/Harness bytes, dependency manifest, public positive/negative consumer and
