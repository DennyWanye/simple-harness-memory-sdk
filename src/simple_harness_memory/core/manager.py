...
class MemoryManager:
    ...
    async def append_message(
        self, session_id, role, content, *, user_id, source_event_id,
        payload_hash=None, salience=0.0, decay_rate=0.02,
    ):
    ...
    async def get_recent_messages(self, session_id, limit=20, *, user_id):
        return await self._backend.get_recent_messages(
            session_id, limit, user_id=user_id
        )
    ...
    async def extract_facts(self, message_id, content, role, *, user_id):
        return await self._backend.extract_facts(
            message_id, content, role, user_id=user_id
        )

    async def get_facts(
        self, subject="user", category=None, active_only=True, *,
        user_id, limit=None,
    ):
    ...
    async def forget_fact(self, fact_id, reason="", *, user_id):
        return await self._backend.forget_fact(
            fact_id, reason, user_id=user_id
        )

    async def recall(self, query, session_id=None, limit=10, *, user_id):
        return await self._backend.recall(
            query, session_id, limit, user_id=user_id
        )
    ...
    async def recall_and_reinforce(
        self, query, session_id=None, limit=10, *, user_id
    ):
        return await self._backend.recall_and_reinforce(
            query, session_id, limit, user_id=user_id
        )

    async def vector_search(self, query, limit=20, *, user_id):
        return await self._backend.vector_search(
            query, limit, user_id=user_id
        )
    ...
    async def detect_inconsistencies(self, subject="user", *, user_id):
        return await self._backend.detect_inconsistencies(
    ...
    async def summarize_old_sessions(
        self, older_than_days=7, max_sessions=5, *, user_id
    ):
    ...
    async def record_workspace_action(
        self, session_id, action_type, payload, *, user_id
    ):
    ...
    async def delete_old_sessions(
        self, older_than_days=30.0, *, user_id, limit=None
    ):
    ...
    async def reindex(self, embedder=None, *, user_id, limit=None):
        return await self._backend.reindex(
            embedder, user_id=user_id, limit=limit
        )

    async def close(self):
        await self._backend.close()
        logger.info(
            "memory.manager_closed", backend_type=type(self._backend).__name__
        )
